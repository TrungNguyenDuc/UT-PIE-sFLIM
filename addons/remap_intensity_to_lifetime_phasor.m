function remap_intensity_to_lifetime_phasor(total_top_tiff,G_t,S_t,n_time_bin,image_size)
figure()
imagesc(total_top_tiff); 
axis square
    ...
    if strcmp(lower(answer(3)), 'n')
        ...
        for index_x = 1:sz
            ...
            if phasor_lifetime_masked(index_x,index_y) == 1
                plot(G_t(index_x,index_y),S_t(index_x,index_y),'.','Color','red')
%                 index_x
%                 index_y
            end
            end
