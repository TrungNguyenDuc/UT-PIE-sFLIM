...
figure;
plot(1:max_clusters, distortions, 'bo-');
title('Elbow Method for Optimal K');
xlabel('Number of Clusters');
ylabel('Distortion');
grid on;

% Determine the optimal number of clusters using the elbow point (visual inspection)
optimal_num_clusters = input('Enter the optimal number of clusters from the plot: ');
